...
enum {
  ...
  NERO_USB_EP0_MAX_PACKET_SIZE = 64u, /* must match CFG_TUD_ENDPOINT0_SIZE in tusb_config.h */
};
...
/* CCID functional descriptor fields (must match ccid_usb_desc_blob.cpp kCc54).
 */
