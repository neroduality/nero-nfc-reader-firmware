...
/*
 * writer_tag_write.c — public API wrappers for tag NDEF write paths.
 */
...
bool writer_tag_write_type4_ndef(void) { return writer_tag_write_type4_impl(); }

bool writer_tag_write_type5_ndef(void) { return writer_tag_write_type5_impl(); }
