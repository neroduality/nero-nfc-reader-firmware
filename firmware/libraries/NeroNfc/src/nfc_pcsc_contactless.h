 ...
 *   [CTAP2.3] NFC transport keep-alive/status SW1 91h.
 *   [T2T-ISO14443-A-NTAG21x] Type 2 AUTH0 GET DATA response length. */
enum {
  ...
  /* [IMPL-POLICY] Nonstandard Mapping 2.0 read-closed sentinel (FFh is RFU for
   * read access; FFh is the standard write-denied value). */
  NFC_PCSC_T4_READ_ACCESS_CLOSED = 0xFFu,
  NFC_PCSC_STORAGE_RID_0 =
      0xA0u, /* [PCSC-P3] §3.1.3 contactless storage RID byte 0 */
  ...
  /* [CTAP2.3] §11.3.5.2 / §11.3.7.2 — SW1 of 9100h keep-alive/status word. */
  NFC_ISO7816_SW1_MORE_DATA_VENDOR = 0x91u,
  ...
  /* [DERIVED] Firmware-local SELECT-by-AID cap, not the ISO7816 short-Lc
     maximum. */
  NFC_ISO7816_SELECT_AID_MAX = 16u,
  /* ISO/IEC 7816-4 §5.1.1 class bytes — short-form C-APDU CLA.
   * CLA FFh is invalid in ISO 7816-4; NFC_ISO7816_CLA_PROPRIETARY holds the
   * PC/SC contactless vendor/escape CLA (e.g. ACR122U FF 00 …). */
  ...
  /* ISO/IEC 7816-3 §8.2.2 — T0 Y(1) bit for TD1 present (not K length). */
  NFC_ISO7816_ATR_T0_TD1_PRESENT = 0x80u,
  NFC_ISO7816_ATR_TD1_T1 = 0x01u,
  NFC_ISO7816_ATR_FIXED_PREFIX_LEN = 3u,
  NFC_ISO7816_ATR_TS_TCK_OVERHEAD = 4u,
  /* [DERIVED] Status-classification helpers; SW byte values are traced
     separately. */
  ...
  /* [DERIVED] Parser mask for CTAP P1 high-bit handling, not an ISO7816
     literal. */
  ...
  /* [DERIVED] Response parser guard lengths; SW trailer width is traced
     separately. */
  ...
  /* [T2T-ISO14443-A-NTAG21x] AUTH0 is one configuration byte. */
  ...
  /* UM0701-02: InRelease = 52h (ReadRegister is 06h). */
  NFC_PN532_CMD_IN_RELEASE = 0x52u,
  NFC_PN532_RSP_IN_RELEASE = 0x53u,
  NFC_PN532_BRTY_106KBPS_TYPE_A = 0x00u,
  NFC_PN532_SINGLE_TARGET = 0x01u,
  NFC_PN532_STATUS_OK = 0x00u,
  /* UM0701-02: 01h = Time Out (target has not answered). */
  NFC_PN532_STATUS_TIMEOUT = 0x01u,
  /* UM0701-02: 27h = command not acceptable due to current context. */
  NFC_PN532_STATUS_CONTEXT_ERROR = 0x27u,
  ...
  /* ACR122U API v2.02 §6.3 — Get Firmware Version P1 (APDU FF 00 48 00 00). */
  NFC_ACR122U_P1_GET_FIRMWARE_VERSION = 0x48u,
};
...
NERO_NFC_STATIC_ASSERT(NFC_PCSC_T4_UPDATE_BINARY_APDU_MAX ==
                           (NFC_ISO7816_SHORT_APDU_HDR_LEN +
...
static const uint8_t NFC_PCSC_STORAGE_RID[NFC_PCSC_STORAGE_RID_LEN] = {
    (uint8_t)NFC_PCSC_STORAGE_RID_0, (uint8_t)NFC_PCSC_STORAGE_RID_1,
    (uint8_t)NFC_PCSC_STORAGE_RID_2, (uint8_t)NFC_PCSC_STORAGE_RID_3,
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_type4_max_message_size(
    uint16_t max_ndef_file_size, uint16_t* max_message_size_out) {
  ...
  *max_message_size_out =
      (uint16_t)(max_ndef_file_size - (uint16_t)NFC_PCSC_T4_NLEN_LEN);
  return true;
}

NERO_NFC_NODISCARD static inline bool nfc_pcsc_type4_message_size_to_file_size(
    uint16_t max_message_size, uint16_t* max_ndef_file_size_out) {
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_storage_card_code_for_tag(
    nfc_tag_kind_t tag_kind, uint8_t* standard_out, uint8_t* card_hi_out,
    uint8_t* card_lo_out) {
...
enum {
  NFC_PCSC_STORAGE_ATR_HISTORY_STANDARD_INDEX = 8u,
  NFC_PCSC_STORAGE_ATR_HISTORY_CARD_HI_INDEX = 9u,
  NFC_PCSC_STORAGE_ATR_HISTORY_CARD_LO_INDEX = 10u,
};

NERO_NFC_NODISCARD static inline bool nfc_pcsc_copy_storage_card_atr(
    nfc_tag_kind_t tag_kind, uint8_t* dst, uint16_t dst_cap,
    uint16_t* alen_io) {
  static const uint8_t K_PREFIX[] = {0x3Bu, 0x8Fu, 0x80u,
                                     0x01u}; /* ISO 7816-3 TS/T0/TD1 */
  static const uint8_t K_HISTORY_TEMPLATE[NFC_ISO7816_HISTORICAL_BYTES_MAX] = {
      0x80u,
      0x4Fu,
      0x0Cu,
  ...
  uint8_t history[NFC_ISO7816_HISTORICAL_BYTES_MAX];
  uint8_t standard = 0u;
  ...
  if ((dst == NERO_NFC_NULL) || (alen_io == NERO_NFC_NULL) ||
      ...
      !nfc_pcsc_storage_card_code_for_tag(tag_kind, &standard, &card_name_hi,
                                          &card_name_lo)) {
    return false;
  }
  if (!nero_nfc_copy_bytes(history, sizeof(history), 0u, K_HISTORY_TEMPLATE,
                           sizeof(K_HISTORY_TEMPLATE))) {
    return false;
  }
  history[NFC_PCSC_STORAGE_ATR_HISTORY_STANDARD_INDEX] = standard;
  history[NFC_PCSC_STORAGE_ATR_HISTORY_CARD_HI_INDEX] = card_name_hi;
  history[NFC_PCSC_STORAGE_ATR_HISTORY_CARD_LO_INDEX] = card_name_lo;

  if (!nero_nfc_copy_bytes(dst, dst_cap, 0u, K_PREFIX, sizeof(K_PREFIX))) {
    return false;
  }
  pos = (uint16_t)sizeof(K_PREFIX);
  if (!nero_nfc_copy_bytes(dst, dst_cap, pos, history, sizeof(history))) {
    return false;
  }
  pos = (uint16_t)(pos + sizeof(history));
  for (uint16_t i = 1u; i < pos; ++i) {
    tck = (uint8_t)(tck ^ nero_nfc_u8_at(dst, (size_t)(dst_cap), (size_t)(i)));
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap), (size_t)(pos), tck)) {
    return false;
  }
  pos = (uint16_t)(pos + 1u);
  *alen_io = pos;
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_aid_matches(
    const uint8_t* aid, uint8_t aid_len, const uint8_t* expect,
    uint8_t expect_len) {
  return (aid != NERO_NFC_NULL) && (expect != NERO_NFC_NULL) &&
         (aid_len == expect_len) && (memcmp(aid, expect, expect_len) == 0);
}

NERO_NFC_NODISCARD static inline bool nfc_pcsc_is_ndef_aid(const uint8_t* aid,
                                                           uint8_t aid_len) {
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_ndef_app_select_variant(
    uint8_t index, nfc_pcsc_ndef_app_select_variant_t* variant_out) {
  static const struct {
    const uint8_t* aid;
    uint8_t p2;
    bool add_le_00;
  } K_VARIANTS[NFC_PCSC_NDEF_APP_SELECT_VARIANT_COUNT] = {
  ...
  variant_out->aid = K_VARIANTS[index].aid;
  variant_out->aid_len = (uint8_t)NFC_PCSC_NDEF_APP_AID_LEN;
  variant_out->p2 = K_VARIANTS[index].p2;
  variant_out->add_le_00 = K_VARIANTS[index].add_le_00;
  return true;
}

NERO_NFC_NODISCARD static inline bool nfc_pcsc_build_t4_select_file_apdu(
    uint16_t file_id, uint8_t* apdu, uint8_t apdu_cap, uint8_t* apdu_len_out) {
  ...
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_CLA),
                         (uint8_t)NFC_ISO7816_CLA_ISO)) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_INS),
                         (uint8_t)NFC_ISO7816_INS_SELECT)) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_P1),
                         (uint8_t)NFC_ISO7816_P1_SELECT_BY_FILE_ID)) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_P2),
                         (uint8_t)NFC_ISO7816_P2_SELECT_NO_FCI)) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_LC),
                         (uint8_t)NFC_ISO7816_LC_SELECT_FILE_ID)) {
    return false;
  }
  if (!nero_nfc_store_u8(
          apdu, (size_t)(apdu_cap), (size_t)(NFC_ISO7816_SHORT_APDU_HDR_LEN),
          (uint8_t)(file_id >> (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT)) ||
      !nero_nfc_store_u8(
          apdu, (size_t)(apdu_cap),
          (size_t)(NFC_ISO7816_SHORT_APDU_HDR_LEN + 1u),
          (uint8_t)(file_id & (uint16_t)NFC_ISO7816_LOW_BYTE_MASK))) {
    return false;
  }
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_build_t4_read_binary_apdu(
    uint16_t offset, uint8_t le, uint8_t* apdu, uint8_t apdu_cap,
  ...
  if (!nero_nfc_store_u8(
          apdu, (size_t)(apdu_cap), (size_t)(NFC_ISO7816_APDU_IDX_P1),
          (uint8_t)(offset >> (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT))) {
    return false;
  }
  if (!nero_nfc_store_u8(
          apdu, (size_t)(apdu_cap), (size_t)(NFC_ISO7816_APDU_IDX_P2),
          (uint8_t)(offset & (uint16_t)NFC_ISO7816_LOW_BYTE_MASK))) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_LC), le)) {
    return false;
  }
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_build_type4_cc_file(
    uint16_t max_ndef_file_size, bool read_access_open, bool write_access_open,
    uint8_t* dst, uint16_t dst_cap, uint16_t* len_out) {
  if (len_out != NERO_NFC_NULL) {
    *len_out = 0u;
  }
  if ((dst == NERO_NFC_NULL) || (len_out == NERO_NFC_NULL) ||
      (dst_cap < NFC_PCSC_T4_CC_FILE_LEN)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_CC_CCLEN_MSB_INDEX),
                         (uint8_t)(0x00u))) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_CC_CCLEN_LSB_INDEX),
                         (uint8_t)NFC_PCSC_T4_CC_FILE_LEN)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_MAPPING_VER_INDEX),
                         (uint8_t)NFC_PCSC_T4_CC_MAPPING_VERSION)) {
    return false;
  }
  if (!nero_nfc_store_u8(
          dst, (size_t)(dst_cap), (size_t)(NFC_TAG_T4T_CC_MLE_MSB_INDEX),
          (uint8_t)(NFC_PCSC_T4_CC_DEFAULT_MLE >>
                    (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT))) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_MLE_LSB_INDEX),
                         (uint8_t)(NFC_PCSC_T4_CC_DEFAULT_MLE &
                                   (uint16_t)NFC_ISO7816_LOW_BYTE_MASK))) {
    return false;
  }
  if (!nero_nfc_store_u8(
          dst, (size_t)(dst_cap), (size_t)(NFC_TAG_T4T_CC_MLC_MSB_INDEX),
          (uint8_t)(NFC_PCSC_T4_CC_DEFAULT_MLC >>
                    (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT))) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_MLC_LSB_INDEX),
                         (uint8_t)(NFC_PCSC_T4_CC_DEFAULT_MLC &
                                   (uint16_t)NFC_ISO7816_LOW_BYTE_MASK))) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_NDEF_TLV_TAG_INDEX),
                         (uint8_t)NFC_PCSC_T4_NDEF_FC_TLV_TAG)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_NDEF_TLV_LEN_INDEX),
                         (uint8_t)NFC_PCSC_T4_NDEF_FC_TLV_LEN)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_NDEF_FILE_ID_MSB_INDEX),
                         (uint8_t)NFC_PCSC_T4_NDEF_FILE_ID_MSB) ||
      !nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_NDEF_FILE_ID_LSB_INDEX),
                         (uint8_t)NFC_PCSC_T4_NDEF_FILE_ID_LSB) ||
      !nero_nfc_store_u8(
          dst, (size_t)(dst_cap), (size_t)(NFC_TAG_T4T_CC_NDEF_SIZE_MSB_INDEX),
          (uint8_t)(max_ndef_file_size >>
                    (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT)) ||
      !nero_nfc_store_u8(dst, (size_t)(dst_cap),
                         (size_t)(NFC_TAG_T4T_CC_NDEF_SIZE_LSB_INDEX),
                         (uint8_t)(max_ndef_file_size &
                                   (uint16_t)NFC_ISO7816_LOW_BYTE_MASK)) ||
      !nero_nfc_store_u8(
          dst, (size_t)(dst_cap), (size_t)(NFC_TAG_T4T_CC_READ_ACCESS_INDEX),
          read_access_open ? (uint8_t)NFC_PCSC_T4_READ_ACCESS_OPEN
                           : (uint8_t)NFC_PCSC_T4_READ_ACCESS_CLOSED) ||
      !nero_nfc_store_u8(
          dst, (size_t)(dst_cap), (size_t)(NFC_TAG_T4T_CC_WRITE_ACCESS_INDEX),
          write_access_open ? (uint8_t)NFC_PCSC_T4_READ_ACCESS_OPEN
                            : (uint8_t)NFC_PCSC_T4_READ_ACCESS_CLOSED)) {
    return false;
  }
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_min_len(
    uint16_t apdu_len, uint16_t need) {
  return apdu_len >= need;
}

NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_lc(const uint8_t* apdu,
                                                          uint16_t apdu_len,
                                                          uint8_t* lc_out) {
  ...
  *lc_out = nero_nfc_u8_at(apdu, (size_t)(apdu_len),
                           (size_t)(NFC_ISO7816_APDU_IDX_LC));
  return true;
}

NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_lc_body_ok(
    uint16_t apdu_len, uint8_t lc) {
  uint16_t need = 0u;
  return nero_nfc_try_add_u16((uint16_t)NFC_ISO7816_SHORT_APDU_HDR_LEN, lc,
                              &need) &&
         (apdu_len == need);
}

NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_lc_body_with_le_ok(
    uint16_t apdu_len, uint8_t lc) {
  uint16_t need = 0u;
  return nero_nfc_try_add_u16((uint16_t)NFC_ISO7816_APDU_LC_BODY_WITH_LE_PREFIX,
                              lc, &need) &&
         (apdu_len == need);
}

NERO_NFC_NODISCARD static inline const uint8_t* nfc_iso7816_apdu_data_ptr(
    const uint8_t* apdu, uint16_t apdu_len, uint8_t lc) {
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_read_binary(
    const uint8_t* apdu, uint16_t apdu_len, uint16_t* offset_out,
    uint8_t* le_out) {
  ...
  if ((apdu == NERO_NFC_NULL) || (offset_out == NERO_NFC_NULL) ||
      (le_out == NERO_NFC_NULL) ||
      (apdu_len != (uint16_t)NFC_PCSC_T4_READ_BINARY_APDU_LEN)) {
    return false;
  }
  *offset_out =
      (uint16_t)(((uint16_t)nero_nfc_u8_at(apdu, (size_t)(apdu_len),
                                           (size_t)(NFC_ISO7816_APDU_IDX_P1))
                  << (uint16_t)NFC_ISO7816_U16_HIGH_BYTE_SHIFT) |
                 nero_nfc_u8_at(apdu, (size_t)(apdu_len),
                                (size_t)(NFC_ISO7816_APDU_IDX_P2)));
  *le_out = nero_nfc_u8_at(apdu, (size_t)(apdu_len),
                           (size_t)(NFC_ISO7816_APDU_IDX_LC));
  return true;
}

NERO_NFC_NODISCARD static inline bool nfc_iso7816_apdu_update_binary(
    const uint8_t* apdu, uint16_t apdu_len, uint16_t* offset_out,
  ...
  if ((apdu == NERO_NFC_NULL) || (offset_out == NERO_NFC_NULL) ||
      (lc_out == NERO_NFC_NULL) || (data_out == NERO_NFC_NULL) ||
      !nfc_iso7816_apdu_lc(apdu, apdu_len, &lc) ||
      !nero_nfc_try_add_u16((uint16_t)NFC_ISO7816_SHORT_APDU_HDR_LEN, lc,
                            &need) ||
      (apdu_len != need) || (lc == 0u)) {
    return false;
  }
...
NERO_NFC_NODISCARD static inline bool nfc_pcsc_build_select_aid_apdu(
    const uint8_t* aid, uint8_t aid_len, uint8_t p2, bool add_le_00,
  ...
  if ((aid == NERO_NFC_NULL) || (apdu == NERO_NFC_NULL) ||
      (apdu_len_out == NERO_NFC_NULL) || (aid_len == 0u) ||
      (aid_len > (uint8_t)NFC_ISO7816_SELECT_AID_MAX)) {
    return false;
  }
  if (!nero_nfc_try_add_u16((uint16_t)NFC_ISO7816_SHORT_APDU_HDR_LEN, aid_len,
                            &len) ||
  ...
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_P2), p2)) {
    return false;
  }
  if (!nero_nfc_store_u8(apdu, (size_t)(apdu_cap),
                         (size_t)(NFC_ISO7816_APDU_IDX_LC), aid_len)) {
    return false;
  }
  if (!nero_nfc_copy_bytes(apdu, apdu_cap,
                           (uint16_t)NFC_ISO7816_SHORT_APDU_HDR_LEN, aid,
                           aid_len)) {
    return false;
  }
  if (add_le_00) {
    if (!nero_nfc_store_u8(
            apdu, (size_t)(apdu_cap),
            (size_t)((uint16_t)NFC_ISO7816_SHORT_APDU_HDR_LEN + aid_len),
            (uint8_t)NFC_ISO7816_CLA_ISO)) {
      return false;
    }
  }
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_response_sw(
    const uint8_t* resp, int rlen, uint8_t* sw1_out, uint8_t* sw2_out) {
  ...
  if ((resp == NERO_NFC_NULL) || (sw1_out == NERO_NFC_NULL) ||
      (sw2_out == NERO_NFC_NULL) || (rlen < NFC_ISO7816_SW_LEN)) {
    return false;
  }
  *sw1_out =
      nero_nfc_u8_at(resp, (size_t)(rlen), (size_t)(rlen - NFC_ISO7816_SW_LEN));
  *sw2_out = nero_nfc_u8_at(resp, (size_t)(rlen), (size_t)(rlen - 1));
  return true;
}

NERO_NFC_NODISCARD static inline bool nfc_iso7816_response_wrong_length(
    const uint8_t* resp, int rlen, uint8_t* correct_le_out) {
  uint8_t sw1 = 0u;
  uint8_t sw2 = 0u;
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_response_more_data(
    const uint8_t* resp, int rlen, uint8_t* remaining_out) {
  uint8_t sw1 = 0u;
  uint8_t sw2 = 0u;
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_append_sw(
    uint8_t* dst, uint16_t dst_cap, uint16_t data_len, uint8_t sw1, uint8_t sw2,
    uint16_t* out_len) {
  ...
  if ((dst == NERO_NFC_NULL) || (out_len == NERO_NFC_NULL) ||
      !nero_nfc_try_add_size((size_t)data_len, (size_t)NFC_ISO7816_SW_LEN,
                             &response_len) ||
      (response_len > (size_t)dst_cap) ||
      !nero_nfc_span_ok((size_t)data_len, (size_t)NFC_ISO7816_SW_LEN,
                        dst_cap)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap), (size_t)(data_len), sw1)) {
    return false;
  }
  if (!nero_nfc_store_u8(dst, (size_t)(dst_cap), (size_t)(data_len + 1u),
                         sw2)) {
    return false;
  }
...
NERO_NFC_NODISCARD static inline bool nfc_iso7816_response_sw_ok(
    const uint8_t* resp, int rlen) {
  uint8_t sw1 = 0u;
  uint8_t sw2 = 0u;

  return nfc_iso7816_response_sw(resp, rlen, &sw1, &sw2) &&
         (sw1 == (uint8_t)NFC_ISO7816_SW1_SUCCESS) &&
         (sw2 == (uint8_t)NFC_ISO7816_SW2_SUCCESS);
}
