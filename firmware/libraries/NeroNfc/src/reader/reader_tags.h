...
NERO_NFC_NODISCARD bool reader_tags_get_typea_info(nfc_tag_typea_info_t* info);
NERO_NFC_NODISCARD bool reader_tags_get_type2_info(nfc_tag_type2_info_t* info);
/* CC/page-3 only — for PC/SC storage READ BINARY (matches type5 CC probe
 * weight). */
NERO_NFC_NODISCARD bool reader_tags_get_type2_storage_info(
    nfc_tag_type2_info_t* info);
NERO_NFC_NODISCARD bool reader_tags_get_type4_info(nfc_tag_type4_info_t* info);
NERO_NFC_NODISCARD bool reader_tags_get_type5_info(nfc_tag_type5_info_t* info);
NERO_NFC_NODISCARD bool reader_tags_get_tag_info(nfc_tag_info_t* info);
...
NERO_NFC_NODISCARD bool reader_tags_write_type2_ndef_message(
    const uint8_t* ndef, uint16_t ndef_len);
NERO_NFC_NODISCARD bool reader_tags_write_type5_ndef_message(
    const uint8_t* ndef, uint16_t ndef_len);
int reader_tags_type2_transceive(const uint8_t* tx, uint16_t tx_len,
                                 uint8_t* rx, uint16_t rx_max);
NERO_NFC_NODISCARD bool reader_tags_type2_write_page(uint8_t page,
                                                     const uint8_t* data);
...
int reader_tags_type5_transceive(const uint8_t* tx, uint16_t tx_len,
                                 uint8_t* rx, uint16_t rx_max);
NERO_NFC_NODISCARD bool reader_tags_type5_write_block(uint16_t block,
                                                      const uint8_t* data,
                                                      uint8_t data_len);
