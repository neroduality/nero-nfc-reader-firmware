...
NERO_NFC_NODISCARD bool reader_hal_ccid_peek(const uint8_t **buf_out, uint16_t *len_out);
...
NERO_NFC_NODISCARD bool reader_hal_ccid_abort_request_pending(uint8_t *slot_out, uint8_t *seq_out);
